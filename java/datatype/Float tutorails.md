...
二进制的规格化表达方式和十进制科学计数法类似，形如$(-1)^{sign}\times1.b_1b_2...b_n\times2^e$
...
> **非规格化数字**
>
> 对于双精度浮点型来说，指数位全部为0，尾数第一位必须为0，表达式为$(-1)^{sign}\times2^{-1022}\times0.b_1b_2..b_{52}$（非规格化数字规定，指数必须是-1022，如果是单精度，指数必须是-126）
